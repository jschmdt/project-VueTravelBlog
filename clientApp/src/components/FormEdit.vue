          ...
          <div id="addForm">
            ...
            <div class="flex">
              <div class="w-full">
                ...
                <p v-if="isSubmitted" id="stateInfo" class="text-orange-500 my-4">Entry updated</p>
              </div>
            </div>
          </div>
...
// const connectData = () => {
//   console.log('Connect Data from Router')
//   console.log(props.id)
//   console.log(props.city.cityName)
//   inputCity.value = props.city?.cityName
//   inputDateStart.value = props.city?.dateStart
//   inputDateEnd.value = props.city?.dateEnd
//   inputSummary.value = props.city?.summary
//   inputRecommends.value = props.city?.recommends
// }
...
const connectData = () => {
  ...
  // console.log(props.id)
  // console.log(props.city.cityName)
  inputCity.value = myCityDetails.value?.cityName
  inputDateStart.value = myCityDetails.value?.dateStart
  inputDateEnd.value = myCityDetails.value?.dateEnd
  inputSummary.value = myCityDetails.value?.summary
  inputRecommends.value = myCityDetails.value?.recommends
}
...
const submit = () => {
  ...
  if (isValid.value) {
    ...
    console.log(`This is ${props.position}`)
    console.log(cityToAdd.value)
    ApiService.updateDestinationId(cityToAdd.value, parseInt(props.position))
      .then((response) => {
...
const getCityById = async () => {
  await ApiService.getDestinationId(props.id)
    .then((response) => {
      console.log('cityDetails:', response.data)
